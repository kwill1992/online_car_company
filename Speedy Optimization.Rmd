...
### Step 1: Gather and present population data  
...
The optimizatin problem looks like this:
$$min\sum_{i=1}^{10} C_iX_i$$
$$st: X_i \ge S_i~~~\forall i$$
$$X_i \ge 0~~~\forall i,~i=1~to~10$$

$$x \in Integers$$
~where C is the cost from each hub to Houston, where X is the calculated number of vehicles to move from each hub to Houston, & where S is the number of vehicles shipped from each hub to Houston.
$$x \ge 15$$
$$a_i \ge 0~~~\forall i$$
$$x \in A$$
